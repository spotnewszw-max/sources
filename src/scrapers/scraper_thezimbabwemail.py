...
def scrape_thezimbabwemail(max_articles=10):
    """Scrape Thezimbabwemail"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Thezimbabwemail: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_thezimbabwemail(max_articles=5)
