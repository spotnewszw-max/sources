...
def scrape_zimbabwesituation(max_articles=10):
    """Scrape Zimbabwesituation"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Zimbabwesituation: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_zimbabwesituation(max_articles=5)
