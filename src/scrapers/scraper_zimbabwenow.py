...
def scrape_zimbabwenow(max_articles=10):
    """Scrape Zimbabwenow"""
    articles = []
    
    try:
        url = "https://www.zimbabwenow.co.zw/"
        headers = {
        ...
        logger.error(f"Error scraping Zimbabwenow: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_zimbabwenow(max_articles=5)
