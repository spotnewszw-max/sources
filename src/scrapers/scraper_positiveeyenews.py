...
def scrape_positiveeyenews(max_articles=10):
    """Scrape Positiveeyenews"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Positiveeyenews: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_positiveeyenews(max_articles=5)
