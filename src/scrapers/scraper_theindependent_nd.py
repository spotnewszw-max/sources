...
def scrape_theindependent_nd(max_articles=10):
    ...
    try:
        ...
        logger.error(f"Error scraping Theindependent Nd: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_theindependent_nd(max_articles=5)
