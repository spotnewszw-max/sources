...
def scrape_theconversation(max_articles=10):
    """Scrape Theconversation"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Theconversation: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_theconversation(max_articles=5)
