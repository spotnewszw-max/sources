...
def scrape_enviropresszim(max_articles=10):
    """Scrape Enviropresszim"""
    articles = []
    
    try:
        url = "https://enviropresszim.com/"
        headers = {
        ...
        logger.error(f"Error scraping Enviropresszim: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_enviropresszim(max_articles=5)
