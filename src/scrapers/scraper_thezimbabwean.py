...
def scrape_thezimbabwean(max_articles=10):
    """Scrape Thezimbabwean"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Thezimbabwean: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_thezimbabwean(max_articles=5)
