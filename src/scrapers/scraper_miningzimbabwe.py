...
def scrape_miningzimbabwe(max_articles=10):
    """Scrape Miningzimbabwe"""
    articles = []
    ...
    try:
        ...
        logger.error(f"Error scraping Miningzimbabwe: {e}")
        return articles

if __name__ == "__main__":
    articles = scrape_miningzimbabwe(max_articles=5)
